 ...
 <div data-label="Daftar <?= $subtitle ?>" class="df-example demo-table">
     ...
     <button type="button" class="btn btn-outline-primary btn-xs" onclick="Tinta()">
         <span class="fas fa-sync"></span> Refresh
     </button>
     <hr>
     <table id="datatable-tinta" class="table">
         <thead>
             <tr>
                 <th width="3%">No.</th>
                 <th width="15%">Nama Tinta</th>
                 <th width="5%">Warna</th>
                 <th width="15%">Keterangan</th>
                 <th width="15%">Supplier</th>
                 <th width="5%">Isi (Gln)</th>
                 <th width="10%">Harga Tinta(Gln) </th>
                 <th width="10%">Harga(ml)</th>
                 <th width="10%">HPP</th>
                 <th width="5%">Aktif</th>
     ...
     <div class="modal-dialog modal-dialog-centered wd-sm-650" role="document">
         <div class="modal-content">
             ...
             <div class="modal-body pd-sm-t-10 pd-sm-b-20 pd-sm-x-20">
                 <form role="form" class="" method="POST" id="forminputinta" action="">
                     <div class="form-group">

                         <label class="tx-10 tx-uppercase tx-medium tx-spacing-1 mg-b-5 tx-color-03">Nama Tinta</label>
                         <input type="text" class="form-control" placeholder="Nama tinta" id="nama_tinta" name="nama_tinta">
                         ...
                         <div class="row row-sm">
                             ...
                             <div class="col-sm-5 mg-t-20 mg-sm-t-0">
                                 <canvas id="myCanvas" width="30" height="30" style="border:1px" position="absolute" background-color="white"> </canvas>
                             </div><!-- col -->
                         </div>
                         <script>
                         ...
                         <input type="text" class="form-control" rows="2" placeholder="Keterangan" id="keterangan" name="keterangan"></textarea>
                         ...
                         <div class="form-group row mg-b-10">
                             ...
                             <div class=" col-sm-3">
                                 <input type="number" class="form-control" id="hargaml" name="hargaml" value="0" style="text-align: right" min="0" readonly>
                             </div>
                         </div>
                         <div class="form-group row">
                             <label for="inputEmail3" class="col-sm-4 col-form-label tx-color-03 tx-10 tx-uppercase tx-medium">HPP/ML</label>
                             <div class=" col-sm-3">
                                 <input type="number" class="form-control" id="hpp" name="hpp" value="0" style="text-align: right" min="0" readonly>
                             </div>
                         </div>
                     </div>
             ...
             <div class="modal-footer pd-x-5 pd-y-15">
                 ...
                 <button type="button" class="btn btn-outline-primary btn-xs" onclick="doTambahTinta()">
