<div class="content content-components mg-r-0-f">
    ...
    <div data-label="Daftar <?= $subtitle ?>" class="df-example demo-table">
        ...
        <hr>
        <table id="datatable-customer" class="table" style="width:100%">
            <thead>
                <tr>
                    <th>Action</th>
                    <th>Jenis</th>
            ...
            <div class="modal-body pd-sm-t-10 pd-sm-b-20 pd-sm-x-20">
                <div id='qq'>
                    <form role="form" class="" method="POST" id="forminputcustomer" action="">
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="aktif2" name="aktif2" checked>
                                <label id="label-status" class="custom-control-label" for="aktif">Status customer aktif</label>
                            </div>
                        </div>
                    </form>
